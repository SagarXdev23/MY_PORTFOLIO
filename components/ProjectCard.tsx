...
export default function ProjectCard({
  ...
  return (
    <div className="card glass-card text-foreground h-100 d-flex flex-column border-0 p-3 rounded-4 overflow-hidden">
      <div className="card-body p-0 d-flex flex-column justify-content-between h-100">
        <div>
          ...
          <div className="d-flex justify-content-between align-items-start mb-2">
            ...
            {language && (
              <span 
                className="d-flex align-items-center gap-1.5 px-2 py-0.5 rounded-pill text-foreground-muted"
                style={{
                  fontSize: '11px',
          ...
          {/* Description */}
          <p 
            className="card-text text-foreground-muted mt-2 mb-3"
            style={{
              fontSize: '13px',
              lineHeight: '1.5',
              display: '-webkit-box',
        ...
        <div>
          ...
          <div className="d-flex gap-2">
            <button
              ...
              className="btn btn-sm btn-custom-outline d-flex align-items-center justify-content-center gap-1 flex-grow-1 py-2"
              style={{ fontSize: '12px' }}
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn btn-sm btn-gradient d-flex align-items-center justify-content-center gap-1 px-3 py-2 fw-bold"
              style={{
                fontSize: '12px',
                borderRadius: '8px'
              }}
